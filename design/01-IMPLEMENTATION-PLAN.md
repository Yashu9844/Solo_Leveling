...
- [ ] **0.6** `vite.config.ts`: `webp` in PWA `globPatterns`,
...
- [ ] **3.1** `Splash` replacing the blank loading div: wordmark, hairline sweep, 900 ms
...
- [ ] **5.2** Steps 1–3. Keep placeholder `Your name`, buttons `Begin` / `Next` verbatim.
      Gate: fast.
- [ ] **5.3** Steps 4–6. Keep the main-quest placeholder and `Initialise system` verbatim.
...
- [ ] **8.1** Progress chrome + SYSTEM: `Segmented`, a `progress`-art level card,
